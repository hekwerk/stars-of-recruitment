...
if (typeof LINKEDIN_CLIENT_ID === "undefined")
  throw Error(
    `Could not find mandatory environment variable 'LINKEDIN_CLIENT_ID'`
  );
if (typeof LINKEDIN_CLIENT_SECRET === "undefined")
  throw Error(
    `Could not find mandatory environment variable 'LINKEDIN_CLIENT_SECRET'`
  );
